...
# from https://stackoverflow.com/questions/15197673/using-pythons-eval-vs-ast-literal-eval/68732605#68732605
...
def cmd_reken(client, response_topic, message):
    try:
        client.publish(response_topic, str(safe_eval(message)))
